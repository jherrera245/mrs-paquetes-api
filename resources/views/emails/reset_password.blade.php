...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f7f4f1;">
    <div style="width: 100%; max-width: 600px; margin: 20px auto; background: #ffffff; border-radius: 8px; box-shadow: 0 0 20px rgba(0, 0, 0, 0.1); overflow: hidden;">
        <div style="background: linear-gradient(to right,#8c5e3c , #d4a373); padding: 10px; text-align: center; color: #ffffff; border-bottom: 2px solid #8c5e3c;">
            <img src="/xampp/htdocs/mrs-paquetes-api/public/images/logo-claro.png" alt="Logo de Mr Paquetes" style="width: 150px; max-width: 100%;">
        </div>
        <div style="text-align: center; padding: 30px; color: #5a3f2a; border-bottom: 2px solid #8c5e3c;">
            ...
            <p style="font-size: 16px; line-height: 1.5; margin: 10px 0;">Use el siguiente código para verificar su correo electrónico.</p>
